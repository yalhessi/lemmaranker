...
def add_is_weaker(frame, index):
  frame.at[index, 'is_weaker'] = utils.is_weaker_than(frame.at[index, "lemma_name"], frame.at[index, "lemma"], frame.at[index, "helper_lemma_name"], frame.at[index, "helper_lemma"], frame.at[index, "prelude"])

def add_is_stronger(frame, index):
  frame.at[index, 'is_stronger'] = utils.is_stronger_than(frame.at[index, "lemma_name"], frame.at[index, "lemma"], frame.at[index, "helper_lemma_name"], frame.at[index, "helper_lemma"], frame.at[index, "prelude"])
...
def remove_notations(frame, index):
  ...
  frame.at[index, "ugly_theorem"] = utils.disable_notations(frame.at[index, "prelude"], frame.at[index, "theorem"])
  frame.at[index, "ugly_helper_lemma"] = utils.disable_notations(frame.at[index, "prelude"], frame.at[index, "helper_lemma"])
...
def main():
  data = log_parser.read_data('./benchmark')
