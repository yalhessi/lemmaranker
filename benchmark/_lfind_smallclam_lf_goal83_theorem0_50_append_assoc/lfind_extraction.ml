...
let lfind_example_8 =
  Cons ((Succ Zero), (Cons ((Succ Zero), (Cons (Zero, (Cons (Zero, (Cons
    ((Succ Zero), Nil)))))))))
...
let lfind_example_19 =
  Cons ((Succ (Succ (Succ (Succ (Succ Zero))))), (Cons ((Succ (Succ Zero)),
    Nil)))
...
let lfind_example_27 =
  Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons
