...
Compute lfind_eval  (Cons (Succ (Succ (Succ Zero))) (Cons (Succ (Succ Zero)) (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons (Succ (Succ Zero)) Nil)))) (Succ Zero).
...
Compute lfind_eval  (Cons Zero (Cons Zero (Cons (Succ Zero) Nil))) (Succ (Succ Zero)).
