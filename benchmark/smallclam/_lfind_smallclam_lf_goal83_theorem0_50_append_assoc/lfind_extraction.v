...
Definition lfind_example_8  := ( Cons (Succ Zero)         (Cons (Succ Zero) (Cons Zero (Cons Zero (Cons (Succ Zero) Nil))))).
Definition lfind_example_9  := ( Cons Zero Nil).
Definition lfind_example_10  := ( Cons (Succ (Succ Zero)) (Cons (Succ (Succ Zero)) (Cons Zero Nil))).
Definition lfind_example_11  := ( Cons Zero (Cons (Succ Zero) Nil)).
Definition lfind_example_12  := ( Cons Zero Nil).
Definition lfind_example_13  := ( Cons (Succ (Succ Zero))         (Cons (Succ Zero)            (Cons (Succ (Succ (Succ (Succ Zero))))               (Cons (Succ (Succ Zero)) Nil)))).
Definition lfind_example_14  := ( Cons (Succ (Succ (Succ (Succ Zero)))) Nil).
Definition lfind_example_15  := ( Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero Nil)).
...
Definition lfind_example_19  := ( Cons (Succ (Succ (Succ (Succ (Succ Zero)))))         (Cons (Succ (Succ Zero)) Nil)).
Definition lfind_example_20  := ( Cons Zero (Cons Zero Nil)).
Definition lfind_example_21  := ( Cons (Succ (Succ Zero)) (Cons (Succ (Succ Zero)) (Cons Zero Nil))).
