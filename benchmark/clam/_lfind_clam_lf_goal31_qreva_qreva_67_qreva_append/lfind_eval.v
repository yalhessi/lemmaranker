...
Compute lfind_eval  (Cons (Succ (Succ (Succ (Succ (Succ Zero))))) (Cons Zero Nil)) (Succ Zero).

Compute lfind_eval  (Cons (Succ Zero) (Cons (Succ Zero) (Cons (Succ Zero) (Cons Zero Nil)))) (Zero).
...
Compute lfind_eval  (Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil) (Succ (Succ (Succ (Succ Zero)))).
