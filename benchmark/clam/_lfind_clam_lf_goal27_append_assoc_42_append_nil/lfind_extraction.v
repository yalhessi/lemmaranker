...
Definition lfind_example_2  := ( Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil))).
Definition lfind_example_3  := ( Cons (Succ Zero)         (Cons (Succ (Succ (Succ (Succ Zero))))            (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero Nil)))).
...
Definition lfind_example_9  := ( Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)).
...
Definition lfind_example_22  := ( Cons (Succ (Succ Zero))         (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil))).
