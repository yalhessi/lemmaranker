...
Compute lfind_eval  (Cons Zero (Cons (Succ (Succ (Succ Zero))) (Cons (Succ (Succ (Succ Zero))) Nil))).

Compute lfind_eval  (Cons Zero (Cons Zero (Cons Zero (Cons (Succ (Succ (Succ Zero))) Nil)))).
