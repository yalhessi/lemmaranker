...
Definition lfind_example_13  := ( Cons (Succ Zero)         (Cons Zero (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil)))).
...
Definition lfind_example_17  := ( Cons (Succ Zero) (Cons (Succ (Succ Zero)) (Cons Zero Nil))).
Definition lfind_example_18  := ( Cons (Succ (Succ Zero)) Nil).
Definition lfind_example_19  := ( Cons Zero (Cons Zero (Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil)))).
...
Definition lfind_example_23  := ( Cons (Succ Zero) (Cons (Succ (Succ Zero)) (Cons Zero Nil))).
