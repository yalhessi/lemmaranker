...
Compute lfind_eval  (Cons Zero (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))) (Succ Zero).
...
Compute lfind_eval  (Cons Zero (Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil))) (Zero).
...
Compute lfind_eval  (Cons (Succ (Succ Zero)) (Cons (Succ Zero) (Cons Zero (Cons (Succ (Succ (Succ (Succ Zero)))) Nil)))) (Zero).
