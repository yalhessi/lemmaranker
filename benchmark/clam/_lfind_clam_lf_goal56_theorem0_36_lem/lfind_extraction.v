...
Definition lfind_example_15  := ( Cons (Succ Zero) (Cons Zero (Cons (Succ Zero) (Cons Zero Nil)))).
...
Definition lfind_example_23  := ( Cons (Succ (Succ (Succ (Succ Zero))))         (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))).
Definition lfind_example_24  := ( Nil).
Definition lfind_example_25  := ( Nil).
Definition lfind_example_26  := ( Cons Zero (Cons Zero (Cons (Succ Zero) Nil))).
