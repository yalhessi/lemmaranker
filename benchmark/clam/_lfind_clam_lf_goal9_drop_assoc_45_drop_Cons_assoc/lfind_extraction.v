...
Definition lfind_example_2  := ( Cons (Succ (Succ Zero)) (Cons (Succ (Succ Zero)) Nil)).
...
Definition lfind_example_8  := ( Cons (Succ Zero)         (Cons (Succ (Succ Zero))            (Cons (Succ (Succ Zero))               (Cons (Succ Zero)                  (Cons Zero (Cons Zero (Cons (Succ Zero) Nil))))))).
...
Definition lfind_example_12  := ( Cons Zero (Cons Zero (Cons Zero (Cons Zero Nil)))).
Definition lfind_example_13  := ( Nil).
Definition lfind_example_14  := ( Cons (Succ (Succ (Succ Zero))) (Cons (Succ (Succ Zero)) Nil)).
Definition lfind_example_15  := ( Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil))).
...
Definition lfind_example_21  := ( Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil)).
