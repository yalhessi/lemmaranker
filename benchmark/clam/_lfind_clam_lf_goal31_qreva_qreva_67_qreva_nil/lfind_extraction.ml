...
let lfind_example_3 =
  Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ
...
let lfind_example_7 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ Zero), (Cons (Zero, (Cons (Zero,
    Nil)))))))
...
let lfind_example_10 =
  Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ (Succ Zero))),
    Nil)))))
...
let lfind_example_11 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ
    (Succ (Succ (Succ (Succ (Succ Zero)))))), (Cons (Zero, Nil)))))))
