...
Definition lfind_example_7  := ( Succ (Succ (Succ (Succ (Succ Zero))))).
...
Definition lfind_example_12  := ( Succ (Succ (Succ (Succ Zero)))).
...
Definition lfind_example_20  := ( Succ (Succ (Succ (Succ Zero)))).
...
Definition lfind_example_25  := ( Succ (Succ (Succ (Succ (Succ Zero))))).
