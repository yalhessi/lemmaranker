...
Compute lfind_eval  (Cons (Succ (Succ (Succ Zero))) (Cons Zero (Cons Zero Nil))) (Succ Zero).
...
Compute lfind_eval  (Cons (Succ (Succ (Succ Zero))) (Cons (Succ Zero) (Cons (Succ Zero) (Cons Zero Nil)))) (Zero).
