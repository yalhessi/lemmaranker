...
Compute lfind_eval  (Cons Zero (Cons (Succ Zero) (Cons (Succ Zero) (Cons Zero (Cons Zero Nil))))).

Compute lfind_eval  (Cons (Succ (Succ Zero)) (Cons Zero Nil)).

Compute lfind_eval  (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons (Succ (Succ (Succ (Succ Zero)))) Nil)).

Compute lfind_eval  (Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil).

Compute lfind_eval  (Cons (Succ (Succ Zero)) (Cons Zero (Cons (Succ Zero) (Cons (Succ Zero) Nil)))).
...
Compute lfind_eval  (Cons (Succ (Succ Zero)) (Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))))).
