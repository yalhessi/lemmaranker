...
let lfind_example_3 =
  Cons ((Succ Zero), (Cons (Zero, (Cons ((Succ (Succ (Succ Zero))), Nil)))))

(** val lfind_example_4 : lst **)

let lfind_example_4 =
  Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons
    (Zero, (Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons (Zero,
    Nil)))))))))))))))
...
let lfind_example_7 =
  Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons ((Succ Zero), (Cons (Zero,
    (Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ
    (Succ (Succ Zero)))), (Cons ((Succ (Succ Zero)), Nil)))))))))))))
...
let lfind_example_18 =
  Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons (Zero, Nil)))))))

(** val lfind_example_19 : lst **)

let lfind_example_19 =
  Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons ((Succ (Succ
    Zero)), Nil)))))))
