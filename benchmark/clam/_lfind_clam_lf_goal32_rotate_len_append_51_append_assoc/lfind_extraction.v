...
Definition lfind_example_1  := ( Cons Zero (Cons (Succ (Succ Zero)) (Cons (Succ (Succ Zero)) Nil))).
...
Definition lfind_example_8  := ( Cons (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))) Nil).
Definition lfind_example_9  := ( Cons (Succ Zero) (Cons (Succ Zero) Nil)).
Definition lfind_example_10  := ( Cons (Succ Zero) Nil).
Definition lfind_example_11  := ( Cons Zero (Cons (Succ Zero) (Cons Zero Nil))).
...
Definition lfind_example_15  := ( Cons Zero         (Cons (Succ Zero) (Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil)))).
Definition lfind_example_16  := ( Cons Zero Nil).
Definition lfind_example_17  := ( Cons (Succ (Succ Zero)) (Cons (Succ Zero) (Cons Zero Nil))).
