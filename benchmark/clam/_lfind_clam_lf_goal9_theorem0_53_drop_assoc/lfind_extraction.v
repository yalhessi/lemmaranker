...
Definition lfind_example_5  := ( Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil)).
...
Definition lfind_example_21  := ( Cons Zero (Cons Zero (Cons Zero Nil))).
...
Definition lfind_example_27  := ( Cons Zero (Cons (Succ (Succ (Succ Zero))) Nil)).
Definition lfind_example_28  := ( Cons (Succ Zero) Nil).
Definition lfind_example_29  := ( Cons (Succ (Succ (Succ (Succ Zero))))         (Cons Zero (Cons (Succ (Succ Zero)) (Cons Zero Nil)))).
