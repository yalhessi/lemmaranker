...
Compute lfind_eval  (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)) (Succ Zero).

Compute lfind_eval  (Cons Zero (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons (Succ (Succ (Succ Zero))) Nil))) (Succ (Succ (Succ (Succ Zero)))).
