...
Definition lfind_example_1  := ( Cons (Succ (Succ (Succ Zero))) (Cons (Succ Zero) (Cons Zero Nil))).
Definition lfind_example_2  := ( Nil).
Definition lfind_example_3  := ( Cons (Succ (Succ (Succ (Succ Zero))))         (Cons Zero (Cons (Succ Zero) (Cons Zero (Cons (Succ Zero) Nil))))).
...
Definition lfind_example_11  := ( Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil)).
Definition lfind_example_12  := ( Cons (Succ Zero) Nil).
Definition lfind_example_13  := ( Cons (Succ Zero)         (Cons (Succ (Succ Zero)) (Cons Zero (Cons Zero (Cons Zero Nil))))).
...
Definition lfind_example_22  := ( Cons Zero (Cons (Succ Zero) (Cons Zero (Cons (Succ (Succ Zero)) Nil)))).
