...
let lfind_example_3 =
  Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons (Zero, (Cons ((Succ Zero),
...
let lfind_example_22 =
  Cons (Zero, (Cons ((Succ Zero), (Cons (Zero, (Cons ((Succ (Succ Zero)),
    Nil)))))))
...
let lfind_example_29 =
  Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons ((Succ (Succ
    Zero)), (Cons (Zero, (Cons ((Succ Zero), (Cons (Zero, (Cons (Zero, (Cons
    ((Succ (Succ Zero)), (Cons (Zero, (Cons (Zero, (Cons ((Succ Zero),
    Nil)))))))))))))))))))))))
...
let lfind_example_30 =
  Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ
    Zero), (Cons ((Succ (Succ (Succ (Succ (Succ Zero))))), Nil)))))))))

(** val lfind_example_31 : lst **)

let lfind_example_31 =
  Cons (Zero, (Cons ((Succ (Succ (Succ (Succ (Succ (Succ Zero)))))), (Cons
    (Zero, (Cons (Zero, (Cons (Zero, (Cons (Zero, (Cons (Zero,
    Nil)))))))))))))
