...
QCInclude "/home/yousef/lemmafinder/benchmark/_lfind_clam_lf_goal50_count_insort_diff_163_count_cons_diff/".
QCInclude ".".
...
Definition collect_data  (x:natural) (y:natural) (n:natural) (l:lst) :=
 let lfind_var := "x:" ++ "(" ++ show x ++ ")"++ "|" ++"y:" ++ "(" ++ show y ++ ")"++ "|" ++"n:" ++ "(" ++ show n ++ ")"++ "|" ++"l:" ++ "(" ++ show l ++ ")"
 in let lfind_v := print x lfind_var
 in lfind_state lfind_v  y n l.
