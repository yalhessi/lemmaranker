...
let lfind_example_5 =
  Cons (Zero, (Cons (Zero, (Cons ((Succ Zero), (Cons (Zero, (Cons (Zero,
    (Cons (Zero, Nil)))))))))))
...
let lfind_example_9 =
  Cons ((Succ Zero), (Cons ((Succ Zero), (Cons (Zero, (Cons ((Succ Zero),
    Nil)))))))
...
let lfind_example_11 =
  Cons ((Succ Zero), (Cons (Zero, (Cons ((Succ (Succ (Succ (Succ Zero)))),
    Nil)))))
...
let lfind_example_20 =
  Cons ((Succ Zero), (Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons ((Succ
    (Succ (Succ (Succ Zero)))), (Cons ((Succ (Succ Zero)), Nil)))))))))
...
let lfind_example_31 =
  Cons ((Succ Zero), (Cons ((Succ (Succ (Succ Zero))), (Cons (Zero, (Cons
    ((Succ Zero), Nil)))))))
