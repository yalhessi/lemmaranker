...
let lfind_example_2 =
  Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons (Zero, (Cons (Zero, (Cons
    (Zero, (Cons ((Succ Zero), (Cons ((Succ Zero), Nil)))))))))))
...
let lfind_example_8 =
  Cons (Zero, (Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons (Zero, (Cons
    ((Succ Zero), (Cons ((Succ Zero), (Cons ((Succ (Succ (Succ Zero))), (Cons
    (Zero, Nil)))))))))))))
