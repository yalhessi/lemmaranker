...
Definition lfind_example_3  := ( Succ         (Succ            (Succ               (Succ                  (Succ                     (Succ                        (Succ                           (Succ                              (Succ                                 (Succ                                    (Succ                                       (Succ (Succ (Succ (Succ (Succ Zero)))))))))))))))).
Definition lfind_example_4  := ( Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero))))))))).
Definition lfind_example_5  := ( Zero).
Definition lfind_example_6  := ( Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))).
