...
Definition lfind_example_4  := ( Cons Zero (Cons (Succ Zero) (Cons Zero (Cons Zero Nil)))).
Definition lfind_example_5  := ( Cons Zero Nil).
Definition lfind_example_6  := ( Cons Zero         (Cons (Succ (Succ Zero))            (Cons Zero (Cons Zero (Cons (Succ Zero) Nil))))).
...
Definition lfind_example_12  := ( Cons (Succ (Succ Zero))         (Cons (Succ Zero)            (Cons (Succ (Succ Zero))               (Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil)))).
Definition lfind_example_13  := ( Cons (Succ Zero) (Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil))).
...
Definition lfind_example_19  := ( Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil)).
...
Definition lfind_example_25  := ( Cons Zero (Cons Zero (Cons (Succ Zero) Nil))).
Definition lfind_example_26  := ( Cons Zero (Cons Zero Nil)).
Definition lfind_example_27  := ( Cons (Succ (Succ (Succ Zero))) Nil).
