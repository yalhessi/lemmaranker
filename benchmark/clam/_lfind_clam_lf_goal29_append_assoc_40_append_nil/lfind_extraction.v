...
Definition lfind_example_4  := ( Cons (Succ (Succ (Succ (Succ Zero))))         (Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil))).
Definition lfind_example_5  := ( Cons Zero Nil).
Definition lfind_example_6  := ( Cons Zero (Cons Zero Nil)).
Definition lfind_example_7  := ( Cons (Succ Zero)         (Cons (Succ (Succ (Succ (Succ Zero))))            (Cons Zero (Cons (Succ (Succ (Succ Zero))) Nil)))).
Definition lfind_example_8  := ( Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil)).
Definition lfind_example_9  := ( Cons (Succ Zero) (Cons Zero Nil)).
Definition lfind_example_10  := ( Cons (Succ (Succ Zero)) (Cons Zero Nil)).
Definition lfind_example_11  := ( Cons (Succ (Succ (Succ Zero)))         (Cons (Succ (Succ (Succ Zero)))            (Cons (Succ Zero) (Cons (Succ Zero) Nil)))).
Definition lfind_example_12  := ( Cons Zero Nil).
Definition lfind_example_13  := ( Cons Zero (Cons Zero (Cons Zero Nil))).
Definition lfind_example_14  := ( Cons Zero         (Cons Zero            (Cons Zero               (Cons Zero (Cons (Succ (Succ (Succ (Succ Zero)))) Nil))))).
...
Definition lfind_example_20  := ( Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil)).
Definition lfind_example_21  := ( Cons (Succ Zero) (Cons Zero (Cons Zero Nil))).
Definition lfind_example_22  := ( Cons Zero Nil).
Definition lfind_example_23  := ( Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil))).
Definition lfind_example_24  := ( Cons (Succ Zero) (Cons Zero Nil)).
Definition lfind_example_25  := ( Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero (Cons Zero Nil))).
Definition lfind_example_26  := ( Cons Zero Nil).
Definition lfind_example_27  := ( Cons Zero Nil).
Definition lfind_example_28  := ( Cons Zero (Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)))).
