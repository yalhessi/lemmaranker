...
Compute lfind_eval  (Cons Zero (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons (Succ Zero) Nil))).
...
Compute lfind_eval  (Cons (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))) (Cons (Succ (Succ Zero)) Nil)).
