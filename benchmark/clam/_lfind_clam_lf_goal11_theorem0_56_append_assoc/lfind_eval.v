...
Compute lfind_eval  (Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ Zero)) (Cons (Succ (Succ Zero)) (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)))))) (Zero).
...
Compute lfind_eval  (Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil) (Zero).

Compute lfind_eval  (Cons Zero Nil) (Succ Zero).

Compute lfind_eval  (Nil) (Succ (Succ Zero)).

Compute lfind_eval  (Cons (Succ (Succ Zero)) (Cons Zero (Cons (Succ (Succ (Succ Zero))) Nil))) (Succ (Succ Zero)).
...
Compute lfind_eval  (Cons Zero (Cons Zero (Cons (Succ Zero) Nil))) (Succ (Succ (Succ (Succ Zero)))).
