...
Definition lfind_example_32  := ( Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil).
Definition lfind_example_33  := ( Cons Zero Nil).
Definition lfind_example_34  := ( Cons (Succ (Succ Zero)) Nil).
Definition lfind_example_35  := ( Cons (Succ (Succ (Succ Zero))) Nil).
