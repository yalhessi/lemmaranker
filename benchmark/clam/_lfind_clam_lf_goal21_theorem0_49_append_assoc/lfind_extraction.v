...
Definition lfind_example_2  := ( Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil).
Definition lfind_example_3  := ( Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)).
Definition lfind_example_4  := ( Cons (Succ (Succ Zero)) Nil).
Definition lfind_example_5  := ( Cons (Succ (Succ (Succ Zero))) (Cons (Succ Zero) Nil)).
...
Definition lfind_example_10  := ( Cons (Succ Zero) (Cons (Succ Zero) (Cons Zero Nil))).
Definition lfind_example_11  := ( Cons Zero         (Cons (Succ (Succ Zero)) (Cons (Succ (Succ (Succ Zero))) Nil))).
...
Definition lfind_example_21  := ( Cons Zero         (Cons (Succ Zero) (Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil)))).
Definition lfind_example_22  := ( Cons Zero (Cons (Succ Zero) Nil)).
Definition lfind_example_23  := ( Cons (Succ (Succ Zero)) Nil).
Definition lfind_example_24  := ( Cons (Succ (Succ Zero))         (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))).
