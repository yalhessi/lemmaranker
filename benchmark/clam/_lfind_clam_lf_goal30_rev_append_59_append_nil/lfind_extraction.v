...
Definition lfind_example_4  := ( Cons Zero (Cons (Succ (Succ Zero)) (Cons (Succ Zero) (Cons Zero Nil)))).
...
Definition lfind_example_7  := ( Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero Nil)).
Definition lfind_example_8  := ( Cons Zero (Cons (Succ (Succ Zero)) Nil)).
Definition lfind_example_9  := ( Cons (Succ (Succ Zero))         (Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)))).
