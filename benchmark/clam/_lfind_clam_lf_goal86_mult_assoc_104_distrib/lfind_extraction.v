...
Definition lfind_example_8  := ( Succ         (Succ            (Succ               (Succ                  (Succ                     (Succ                        (Succ                           (Succ                              (Succ                                 (Succ                                    (Succ (Succ (Succ (Succ (Succ Zero))))))))))))))).
...
Definition lfind_example_25  := ( Succ (Succ (Succ (Succ (Succ (Succ Zero)))))).
Definition lfind_example_26  := ( Zero).

 
                    Extraction "/home/yousef/lemmafinder/benchmark/_lfind_clam_lf_goal86_mult_assoc_104_distrib/lfind_extraction.ml" lfind_example_1 lfind_example_2 lfind_example_3 lfind_example_4 lfind_example_5 lfind_example_6 lfind_example_7 lfind_example_8 lfind_example_9 lfind_example_10 lfind_example_11 lfind_example_12 lfind_example_13 lfind_example_14 lfind_example_15 lfind_example_16 lfind_example_17 lfind_example_18 lfind_example_19 lfind_example_20 lfind_example_21 lfind_example_22 lfind_example_23 lfind_example_24 lfind_example_25 lfind_example_26 .