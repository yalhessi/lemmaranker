...
let lfind_example_2 =
  Cons ((Succ Zero), (Cons (Zero, (Cons (Zero, (Cons ((Succ Zero), (Cons
    ((Succ Zero), (Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ (Succ Zero))),
    (Cons (Zero, Nil)))))))))))))))))
...
let lfind_example_4 =
  Cons ((Succ Zero), (Cons (Zero, (Cons ((Succ (Succ (Succ Zero))), (Cons
...
let lfind_example_10 =
  Cons ((Succ Zero), (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ (Succ
    (Succ Zero))), (Cons ((Succ Zero), Nil)))))))

(** val lfind_example_11 : lst **)

let lfind_example_11 =
  Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons
    (Zero, (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ (Succ (Succ
    Zero))), (Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ (Succ Zero))),
    (Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ (Succ (Succ (Succ Zero))))),
    (Cons ((Succ Zero), (Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons ((Succ
    (Succ (Succ (Succ Zero)))), (Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons
    (Zero, Nil)))))))))))))))))))))))))))))))))))
