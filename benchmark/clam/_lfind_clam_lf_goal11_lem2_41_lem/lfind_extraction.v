...
Definition lfind_example_1  := ( Cons (Succ Zero)         (Cons (Succ Zero) (Cons Zero (Cons Zero (Cons (Succ Zero) Nil))))).
...
Definition lfind_example_7  := ( Cons (Succ Zero) (Cons (Succ Zero) (Cons Zero Nil))).
...
Definition lfind_example_10  := ( Cons (Succ (Succ (Succ (Succ Zero))))         (Cons (Succ (Succ Zero)) (Cons Zero Nil))).
Definition lfind_example_11  := ( Cons Zero (Cons Zero (Cons Zero (Cons (Succ Zero) (Cons Zero Nil))))).
...
Definition lfind_example_15  := ( Cons Zero (Cons (Succ (Succ Zero)) (Cons Zero (Cons Zero Nil)))).
