...
Definition lfind_example_7  := ( Cons Zero (Cons Zero (Cons Zero (Cons Zero Nil)))).
...
Definition lfind_example_12  := ( Cons (Succ (Succ (Succ (Succ Zero)))) (Cons (Succ Zero) Nil)).
Definition lfind_example_13  := ( Cons (Succ (Succ Zero))         (Cons (Succ Zero) (Cons (Succ Zero) (Cons (Succ Zero) Nil)))).
...
Definition lfind_example_19  := ( Cons (Succ (Succ (Succ Zero))) (Cons (Succ Zero) Nil)).
Definition lfind_example_20  := ( Cons (Succ Zero) Nil).
Definition lfind_example_21  := ( Cons (Succ (Succ (Succ Zero)))         (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))).
