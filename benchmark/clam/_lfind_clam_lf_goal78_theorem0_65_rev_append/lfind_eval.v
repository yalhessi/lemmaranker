...
Compute lfind_eval  (Cons (Succ Zero) (Cons (Succ Zero) (Cons (Succ Zero) Nil))) (Succ Zero).
...
Compute lfind_eval  (Cons (Succ Zero) (Cons Zero (Cons Zero (Cons (Succ (Succ (Succ Zero))) Nil)))) (Succ (Succ Zero)).
