...
;;
let synth  (lf3 : natural) (z : natural): natural-> natural-> natural|>
{
...
(  Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))))) => (  Succ (Succ (Succ (Succ Zero)))) => (  Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ (Succ    Zero))))))))))));
(  Succ Zero) => (  Succ Zero) => (  Succ (Succ Zero));
(  Zero) => (  Zero) => (  Zero);
