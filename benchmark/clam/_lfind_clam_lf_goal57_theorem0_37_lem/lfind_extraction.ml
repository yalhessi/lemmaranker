...
let lfind_example_17 =
  Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons ((Succ Zero), (Cons (Zero,
    (Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ (Succ (Succ (Succ (Succ
    Zero)))))), Nil)))))))))))))
...
let lfind_example_27 =
  Cons (Zero, (Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ (Succ Zero)),
    Nil)))))))
...
let lfind_example_31 =
  Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ Zero)), Nil)))))
...
let lfind_example_35 =
  Cons ((Succ Zero), (Cons ((Succ Zero), (Cons ((Succ (Succ Zero)), (Cons
