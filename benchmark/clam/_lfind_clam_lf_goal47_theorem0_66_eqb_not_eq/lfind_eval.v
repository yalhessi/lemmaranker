...
Compute lfind_eval  (Succ Zero) (Cons Zero (Cons Zero (Cons (Succ (Succ Zero)) Nil))).

Compute lfind_eval  (Zero) (Cons (Succ Zero) (Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil))).
...
Compute lfind_eval  (Succ (Succ (Succ Zero))) (Cons Zero (Cons Zero (Cons Zero Nil))).

Compute lfind_eval  (Zero) (Cons (Succ (Succ Zero)) (Cons Zero (Cons Zero Nil))).

Compute lfind_eval  (Succ Zero) (Cons (Succ Zero) Nil).

Compute lfind_eval  (Succ (Succ Zero)) (Nil).

Compute lfind_eval  (Succ (Succ (Succ Zero))) (Cons Zero (Cons (Succ (Succ Zero)) Nil)).
...
Compute lfind_eval  (Zero) (Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil)).
...
Compute lfind_eval  (Succ (Succ Zero)) (Cons (Succ (Succ Zero)) (Cons (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))) Nil)).
