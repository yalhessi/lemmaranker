...
Compute lfind_eval  (Cons Zero (Cons Zero (Cons (Succ Zero) (Cons Zero (Cons Zero Nil))))) (Succ (Succ (Succ Zero))).

Compute lfind_eval  (Cons (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))) Nil) (Zero).
