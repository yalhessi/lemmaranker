...
let lfind_example_7 =
  Cons ((Succ Zero), (Cons ((Succ (Succ Zero)), (Cons ((Succ Zero), Nil)))))
...
let lfind_example_13 =
  Cons ((Succ Zero), (Cons (Zero, (Cons (Zero, (Cons ((Succ Zero), (Cons
    (Zero, (Cons ((Succ (Succ (Succ Zero))), (Cons (Zero, (Cons ((Succ (Succ
    Zero)), Nil)))))))))))))))
...
let lfind_example_14 =
  Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons ((Succ (Succ Zero)), (Cons
    ((Succ Zero), (Cons (Zero, (Cons ((Succ (Succ (Succ Zero))), Nil)))))))))
