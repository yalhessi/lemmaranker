...
Definition lfind_example_9  := ( Cons (Succ (Succ (Succ Zero)))         (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))).
...
Definition lfind_example_16  := ( Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil))).
...
Definition lfind_example_26  := ( Cons Zero (Cons Zero (Cons Zero Nil))).
