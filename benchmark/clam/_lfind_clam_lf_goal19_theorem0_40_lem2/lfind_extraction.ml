...
let lfind_example_4 =
  Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons ((Succ Zero),
...
let lfind_example_15 =
  Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ (Succ (Succ
...
let lfind_example_21 =
  Cons (Zero, (Cons ((Succ Zero), (Cons (Zero, (Cons (Zero, (Cons (Zero,
    Nil)))))))))
