...
let lfind_example_15 =
  Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons (Zero, Nil)))))))
...
let lfind_example_22 =
  Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ (Succ Zero)), (Cons (Zero,
...
let lfind_example_26 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ
    (Succ (Succ Zero))), (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons (Zero,
    Nil)))))))))))
