...
let lfind_example_4 =
  Cons ((Succ Zero), (Cons ((Succ (Succ (Succ Zero))), Nil)))
...
let lfind_example_7 =
  Cons (Zero, (Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons
    (Zero, (Cons (Zero, (Cons (Zero, (Cons (Zero, Nil)))))))))))))))
...
let lfind_example_11 =
  Cons ((Succ Zero), (Cons (Zero, (Cons (Zero, (Cons (Zero, (Cons (Zero,
    Nil)))))))))
...
let lfind_example_12 =
  Cons ((Succ Zero), (Cons ((Succ Zero), (Cons (Zero, (Cons ((Succ (Succ
    Zero)), (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ (Succ Zero)),
    (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons (Zero, (Cons (Zero,
    Nil)))))))))))))))))))
