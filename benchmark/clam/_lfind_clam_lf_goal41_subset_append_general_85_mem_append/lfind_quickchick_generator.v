...
QCInclude "/home/yousef/lemmafinder/benchmark/_lfind_clam_lf_goal41_subset_append_general_85_mem_append/".
QCInclude ".".
...
Definition collect_data  (n:natural) (x:lst) (y:lst) (z:lst) :=
 let lfind_var := "n:" ++ "(" ++ show n ++ ")"++ "|" ++"x:" ++ "(" ++ show x ++ ")"++ "|" ++"y:" ++ "(" ++ show y ++ ")"++ "|" ++"z:" ++ "(" ++ show z ++ ")"
