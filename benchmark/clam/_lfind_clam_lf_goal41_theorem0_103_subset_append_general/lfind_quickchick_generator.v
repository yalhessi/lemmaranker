...
@eq bool (lst_eq (lst_intersection x y) x) true):@eq bool (lst_subset x (append (Cons n Nil) (lst_intersection x y))) true.
Admitted.
From QuickChick Require Import QuickChick.
QCInclude "/home/yousef/lemmafinder/benchmark/_lfind_clam_lf_goal41_theorem0_103_subset_append_general/".
QCInclude ".".
