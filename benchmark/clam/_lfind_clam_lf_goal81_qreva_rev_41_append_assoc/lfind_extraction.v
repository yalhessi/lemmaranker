...
Definition lfind_example_18  := ( Cons (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))) Nil).
...
Definition lfind_example_26  := ( Cons (Succ (Succ (Succ Zero))) Nil).
