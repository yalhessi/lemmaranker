...
Definition lfind_example_3  := ( Cons (Succ Zero) (Cons (Succ (Succ (Succ (Succ Zero)))) Nil)).
...
Definition lfind_example_7  := ( Cons (Succ Zero) (Cons Zero (Cons Zero Nil))).
Definition lfind_example_8  := ( Cons Zero (Cons (Succ (Succ Zero)) (Cons Zero (Cons Zero Nil)))).
Definition lfind_example_9  := ( Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero Nil)).
Definition lfind_example_10  := ( Cons Zero Nil).
Definition lfind_example_11  := ( Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)).
Definition lfind_example_12  := ( Cons Zero (Cons Zero (Cons (Succ (Succ Zero)) Nil))).
...
Definition lfind_example_17  := ( Cons (Succ (Succ (Succ Zero))) Nil).
Definition lfind_example_18  := ( Cons Zero Nil).
Definition lfind_example_19  := ( Cons (Succ Zero) Nil).
Definition lfind_example_20  := ( Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil)).
...
Definition lfind_example_25  := ( Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil)).
Definition lfind_example_26  := ( Cons (Succ Zero) Nil).
Definition lfind_example_27  := ( Cons Zero         (Cons Zero            (Cons Zero               (Cons (Succ Zero)                  (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero Nil)))))).
Definition lfind_example_28  := ( Cons Zero         (Cons (Succ (Succ (Succ (Succ (Succ Zero)))))            (Cons (Succ Zero) (Cons Zero Nil)))).
Definition lfind_example_29  := ( Cons Zero (Cons Zero Nil)).
Definition lfind_example_30  := ( Cons (Succ Zero) (Cons (Succ Zero) (Cons (Succ Zero) Nil))).
Definition lfind_example_31  := ( Cons (Succ Zero) Nil).
Definition lfind_example_32  := ( Cons Zero (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))).
