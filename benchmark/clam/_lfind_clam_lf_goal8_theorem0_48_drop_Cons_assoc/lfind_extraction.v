...
Definition lfind_example_4  := ( Cons (Succ (Succ (Succ (Succ (Succ Zero))))) (Cons Zero Nil)).
...
Definition lfind_example_15  := ( Cons (Succ (Succ Zero)) (Cons Zero (Cons Zero Nil))).
Definition lfind_example_16  := ( Cons (Succ (Succ Zero)) (Cons Zero (Cons (Succ Zero) Nil))).
...
Definition lfind_example_24  := ( Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil)).
