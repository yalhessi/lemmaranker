...
let lfind_example_10 =
  Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons ((Succ (Succ Zero)), Nil)))
...
let lfind_example_21 =
  Cons ((Succ Zero), (Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons ((Succ
    Zero), (Cons (Zero, Nil)))))))
...
let lfind_example_26 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ Zero), (Cons (Zero, (Cons ((Succ
    (Succ (Succ Zero))), Nil)))))))
...
let lfind_example_28 =
  Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ (Succ (Succ Zero)))), Nil)))))
...
let lfind_example_41 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons
    ((Succ Zero), Nil)))))))
