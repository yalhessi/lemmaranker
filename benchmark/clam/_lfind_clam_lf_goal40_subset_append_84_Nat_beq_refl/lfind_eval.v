...
Compute lfind_eval  (Cons (Succ Zero) (Cons Zero (Cons (Succ Zero) Nil))) (Succ (Succ (Succ (Succ Zero)))).

Compute lfind_eval  (Cons Zero (Cons Zero (Cons (Succ Zero) (Cons (Succ Zero) (Cons (Succ Zero) (Cons (Succ Zero) Nil)))))) (Succ Zero).
...
Compute lfind_eval  (Cons (Succ (Succ Zero)) (Cons (Succ (Succ Zero)) (Cons (Succ (Succ Zero)) Nil))) (Zero).
