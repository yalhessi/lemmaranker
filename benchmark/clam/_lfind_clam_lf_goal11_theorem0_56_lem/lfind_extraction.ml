...
let lfind_example_2 =
  Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ Zero), Nil)))))
...
let lfind_example_18 =
  Cons ((Succ Zero), (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons ((Succ
    (Succ Zero)), Nil)))))))
...
let lfind_example_24 =
  Cons (Zero, (Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons
    ((Succ (Succ (Succ Zero))), Nil)))))))))

(** val lfind_example_25 : lst **)

let lfind_example_25 =
  Cons (Zero, (Cons ((Succ (Succ (Succ (Succ Zero)))), (Cons (Zero, Nil)))))

(** val lfind_example_26 : lst **)

let lfind_example_26 =
  Cons ((Succ Zero), (Cons ((Succ Zero), (Cons ((Succ (Succ (Succ Zero))),
    Nil)))))
