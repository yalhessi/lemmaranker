...
let lfind_example_16 =
  Cons (Zero, (Cons ((Succ (Succ (Succ (Succ (Succ Zero))))), (Cons ((Succ
    Zero), (Cons ((Succ (Succ (Succ (Succ (Succ Zero))))), (Cons (Zero, (Cons
    ((Succ (Succ Zero)), Nil)))))))))))
...
let lfind_example_19 =
  Cons ((Succ (Succ (Succ Zero))), (Cons (Zero, (Cons ((Succ (Succ (Succ
    (Succ Zero)))), (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ Zero),
    Nil)))))))))
...
let lfind_example_30 =
  Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ Zero), (Cons ((Succ (Succ
    (Succ Zero))), (Cons (Zero, (Cons (Zero, Nil)))))))))
