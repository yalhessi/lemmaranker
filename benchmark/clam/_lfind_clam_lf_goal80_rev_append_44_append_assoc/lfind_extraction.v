...
Definition lfind_example_1  := ( Cons (Succ Zero) (Cons Zero (Cons Zero Nil))).
Definition lfind_example_2  := ( Cons (Succ (Succ (Succ Zero))) Nil).
Definition lfind_example_3  := ( Cons (Succ (Succ (Succ Zero)))         (Cons (Succ (Succ Zero)) (Cons Zero (Cons Zero Nil)))).
Definition lfind_example_4  := ( Cons Zero (Cons Zero Nil)).
Definition lfind_example_5  := ( Cons Zero (Cons (Succ (Succ Zero)) Nil)).
...
Definition lfind_example_13  := ( Cons (Succ (Succ Zero))         (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))).
Definition lfind_example_14  := ( Cons Zero Nil).
Definition lfind_example_15  := ( Cons Zero (Cons Zero Nil)).
Definition lfind_example_16  := ( Cons (Succ (Succ Zero)) (Cons Zero Nil)).
