...
Compute lfind_eval  (Cons (Succ Zero) (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero (Cons Zero (Cons Zero (Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil)))))) (Zero).
...
Compute lfind_eval  (Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) (Cons (Succ (Succ (Succ Zero))) Nil))) (Succ Zero).
