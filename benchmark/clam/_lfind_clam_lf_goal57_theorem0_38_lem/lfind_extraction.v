...
Definition lfind_example_6  := ( Cons Zero         (Cons (Succ Zero)            (Cons (Succ (Succ (Succ (Succ Zero))))               (Cons Zero                  (Cons Zero                     (Cons Zero                        (Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil))))))).
...
Definition lfind_example_10  := ( Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)).
Definition lfind_example_11  := ( Cons (Succ Zero) (Cons Zero (Cons Zero (Cons Zero Nil)))).
...
Definition lfind_example_20  := ( Cons (Succ Zero)         (Cons (Succ Zero)            (Cons (Succ (Succ (Succ Zero)))               (Cons (Succ (Succ (Succ Zero))) Nil)))).
Definition lfind_example_21  := ( Cons Zero Nil).
Definition lfind_example_22  := ( Cons Zero (Cons (Succ (Succ (Succ (Succ (Succ Zero))))) Nil)).
...
Definition lfind_example_32  := ( Cons Zero (Cons (Succ (Succ Zero)) Nil)).
