...
let lfind_example_3 =
  Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ Zero), (Cons ((Succ (Succ
    (Succ Zero))), (Cons ((Succ Zero), (Cons (Zero, (Cons ((Succ Zero),
    Nil)))))))))))
...
let lfind_example_8 =
  Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons (Zero, (Cons (Zero, (Cons
    ((Succ (Succ Zero)), (Cons ((Succ (Succ (Succ Zero))), (Cons (Zero, (Cons
...
let lfind_example_10 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ
    (Succ (Succ Zero))), (Cons (Zero, (Cons ((Succ (Succ (Succ Zero))), (Cons
    ((Succ Zero), (Cons (Zero, (Cons ((Succ Zero), (Cons (Zero,
    Nil)))))))))))))))))
...
let lfind_example_15 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ Zero), (Cons ((Succ (Succ (Succ
    Zero))), (Cons (Zero, (Cons ((Succ Zero), (Cons ((Succ (Succ Zero)),
    Nil)))))))))))
...
let lfind_example_18 =
  Cons ((Succ (Succ Zero)), (Cons (Zero, (Cons (Zero, (Cons (Zero, (Cons
    (Zero, (Cons (Zero, (Cons ((Succ (Succ (Succ Zero))), Nil)))))))))))))
...
let lfind_example_21 =
  Cons (Zero, (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ Zero), (Cons
    (Zero, (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ (Succ (Succ
    Zero))), (Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ (Succ (Succ
    Zero)))), (Cons (Zero, Nil)))))))))))))))))))
...
let lfind_example_22 =
  Cons ((Succ (Succ (Succ Zero))), (Cons (Zero, (Cons (Zero, (Cons (Zero,
    ...
    Zero))), (Cons (Zero, (Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ
    Zero), (Cons ((Succ Zero), (Cons (Zero, (Cons (Zero, (Cons ((Succ Zero),
    (Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ Zero)),
    Nil)))))))))))))))))))))))))))))))))
...
let lfind_example_26 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ (Succ (Succ (Succ Zero)))), Nil)))
...
let lfind_example_32 =
  Cons ((Succ (Succ Zero)), (Cons ((Succ Zero), (Cons ((Succ Zero), (Cons
