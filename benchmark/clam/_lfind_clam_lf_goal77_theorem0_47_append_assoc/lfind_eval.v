...
Compute lfind_eval  (Cons Zero (Cons (Succ (Succ Zero)) (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero (Cons Zero Nil))))) (Zero).
...
Compute lfind_eval  (Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil))) (Succ Zero).
