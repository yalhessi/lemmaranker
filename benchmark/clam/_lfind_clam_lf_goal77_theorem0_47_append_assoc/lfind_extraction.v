...
Definition lfind_example_3  := ( Cons Zero         (Cons Zero            (Cons (Succ (Succ Zero))               (Cons (Succ (Succ (Succ (Succ Zero))))                  (Cons Zero (Cons Zero Nil)))))).
Definition lfind_example_4  := ( Cons Zero (Cons Zero Nil)).
Definition lfind_example_5  := ( Cons Zero (Cons (Succ (Succ Zero)) (Cons Zero Nil))).
Definition lfind_example_6  := ( Cons (Succ (Succ Zero)) Nil).
Definition lfind_example_7  := ( Cons Zero Nil).
Definition lfind_example_8  := ( Cons Zero (Cons Zero (Cons Zero Nil))).
Definition lfind_example_9  := ( Cons (Succ Zero) (Cons Zero Nil)).
Definition lfind_example_10  := ( Cons Zero (Cons Zero (Cons (Succ Zero) Nil))).
...
Definition lfind_example_15  := ( Cons Zero (Cons Zero (Cons Zero (Cons Zero Nil)))).
Definition lfind_example_16  := ( Cons (Succ (Succ (Succ (Succ (Succ (Succ Zero)))))) Nil).
Definition lfind_example_17  := ( Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil))).
Definition lfind_example_18  := ( Cons Zero Nil).
Definition lfind_example_19  := ( Cons (Succ Zero)         (Cons Zero (Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil)))).
