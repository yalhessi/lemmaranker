...
Definition lfind_example_7  := ( Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil)).
...
Definition lfind_example_15  := ( Cons Zero (Cons Zero (Cons (Succ (Succ (Succ (Succ Zero)))) Nil))).
Definition lfind_example_16  := ( Cons Zero (Cons Zero (Cons Zero Nil))).
Definition lfind_example_17  := ( Cons (Succ Zero) Nil).
Definition lfind_example_18  := ( Cons Zero (Cons (Succ (Succ (Succ Zero))) (Cons Zero Nil))).
Definition lfind_example_19  := ( Cons Zero Nil).
Definition lfind_example_20  := ( Cons (Succ (Succ Zero)) Nil).
Definition lfind_example_21  := ( Cons (Succ Zero)         (Cons (Succ (Succ Zero))            (Cons (Succ Zero)               (Cons (Succ Zero) (Cons (Succ (Succ Zero)) (Cons Zero Nil)))))).
...
Definition lfind_example_25  := ( Cons (Succ (Succ Zero)) (Cons (Succ Zero) Nil)).
...
Definition lfind_example_29  := ( Cons (Succ Zero)         (Cons (Succ (Succ (Succ (Succ Zero))))            (Cons Zero               (Cons (Succ (Succ (Succ (Succ Zero)))) (Cons Zero Nil))))).
