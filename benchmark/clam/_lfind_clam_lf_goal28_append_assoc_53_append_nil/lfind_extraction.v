...
Definition lfind_example_5  := ( Cons Zero         (Cons Zero            (Cons Zero               (Cons Zero                  (Cons (Succ Zero) (Cons (Succ Zero) (Cons Zero Nil))))))).
Definition lfind_example_6  := ( Cons Zero (Cons (Succ Zero) (Cons Zero Nil))).
Definition lfind_example_7  := ( Cons (Succ Zero) Nil).
Definition lfind_example_8  := ( Cons (Succ Zero)         (Cons Zero (Cons (Succ (Succ (Succ (Succ Zero)))) Nil))).
...
Definition lfind_example_12  := ( Cons (Succ Zero) (Cons (Succ Zero) Nil)).
Definition lfind_example_13  := ( Cons Zero (Cons (Succ (Succ Zero)) (Cons Zero Nil))).
Definition lfind_example_14  := ( Cons Zero (Cons Zero (Cons (Succ Zero) Nil))).
Definition lfind_example_15  := ( Cons (Succ Zero)         (Cons (Succ (Succ (Succ Zero))) (Cons (Succ Zero) Nil))).
Definition lfind_example_16  := ( Cons (Succ Zero) (Cons Zero Nil)).
Definition lfind_example_17  := ( Cons (Succ (Succ Zero)) Nil).
Definition lfind_example_18  := ( Cons (Succ (Succ Zero))         (Cons (Succ Zero)            (Cons (Succ (Succ (Succ Zero)))               (Cons Zero (Cons (Succ Zero) Nil))))).
Definition lfind_example_19  := ( Cons (Succ Zero) (Cons (Succ Zero) Nil)).
...
Definition lfind_example_25  := ( Cons (Succ (Succ Zero)) (Cons Zero (Cons Zero (Cons Zero Nil)))).
Definition lfind_example_26  := ( Cons Zero         (Cons (Succ Zero)            (Cons (Succ (Succ (Succ (Succ (Succ Zero)))))               (Cons Zero (Cons Zero Nil))))).
Definition lfind_example_27  := ( Cons (Succ Zero) (Cons (Succ Zero) Nil)).
Definition lfind_example_28  := ( Cons (Succ (Succ Zero)) Nil).
Definition lfind_example_29  := ( Cons (Succ (Succ Zero)) (Cons (Succ Zero) (Cons Zero Nil))).
Definition lfind_example_30  := ( Cons Zero         (Cons (Succ (Succ Zero)) (Cons Zero (Cons Zero (Cons Zero Nil))))).
Definition lfind_example_31  := ( Cons Zero (Cons (Succ (Succ (Succ Zero))) Nil)).
