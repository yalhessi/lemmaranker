...
let lfind_example_4 =
  Cons (Zero, (Cons (Zero, (Cons (Zero, (Cons ((Succ Zero), (Cons (Zero,
    Nil)))))))))
...
let lfind_example_10 =
  Cons (Zero, (Cons (Zero, (Cons ((Succ (Succ Zero)), (Cons ((Succ Zero),
    (Cons ((Succ Zero), Nil)))))))))
...
let lfind_example_13 =
  Cons ((Succ Zero), (Cons ((Succ Zero), (Cons (Zero, (Cons (Zero, Nil)))))))
...
let lfind_example_18 =
  Cons ((Succ (Succ (Succ Zero))), (Cons ((Succ (Succ (Succ (Succ Zero)))),
    Nil)))
...
let lfind_example_26 =
  Cons ((Succ Zero), (Cons ((Succ (Succ (Succ (Succ (Succ (Succ Zero)))))),
    Nil)))
