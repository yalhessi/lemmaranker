...
Definition lfind_example_3  := ( Cons (Succ (Succ Zero))         (Cons (Succ Zero) (Cons (Succ (Succ Zero)) (Cons Zero Nil)))).
Definition lfind_example_4  := ( Cons (Succ Zero) Nil).
Definition lfind_example_5  := ( Cons Zero (Cons Zero (Cons Zero (Cons (Succ (Succ (Succ Zero))) Nil)))).
Definition lfind_example_6  := ( Cons (Succ Zero) (Cons Zero Nil)).
Definition lfind_example_7  := ( Cons Zero Nil).
Definition lfind_example_8  := ( Cons (Succ Zero) (Cons (Succ (Succ Zero)) Nil)).
...
Definition lfind_example_12  := ( Cons (Succ (Succ (Succ Zero)))         (Cons Zero (Cons Zero (Cons Zero (Cons Zero (Cons Zero Nil)))))).
Definition lfind_example_13  := ( Cons Zero Nil).
Definition lfind_example_14  := ( Cons (Succ (Succ Zero))         (Cons (Succ Zero)            (Cons (Succ Zero) (Cons (Succ (Succ (Succ Zero))) Nil)))).
Definition lfind_example_15  := ( Cons (Succ Zero) Nil).
Definition lfind_example_16  := ( Cons Zero Nil).
Definition lfind_example_17  := ( Cons (Succ Zero) (Cons (Succ Zero) (Cons Zero Nil))).
